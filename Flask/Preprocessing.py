...
def main():
    ...
    filenames = ['C:/Users/Utilisateur/Desktop/Projet/Flask/csv/' + str.lower(job).replace(' ', '') + str.lower(country) + '.csv' for job, country in
                 zip(jobs, countrys)]
    ...
    data.to_csv('csv/Prepo.csv', index=False, sep=';', encoding="utf-8-sig")
